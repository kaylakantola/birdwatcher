...
export declare class SecretManagerServiceClient {
    ...
    createSecret(request: protos.google.cloud.secretmanager.v1.ICreateSecretRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.ICreateSecretRequest | undefined, {} | undefined]>;
    createSecret(request: protos.google.cloud.secretmanager.v1.ICreateSecretRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.ICreateSecretRequest | null | undefined, {} | null | undefined>): void;
    ...
    addSecretVersion(request: protos.google.cloud.secretmanager.v1.IAddSecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IAddSecretVersionRequest | undefined, {} | undefined]>;
    addSecretVersion(request: protos.google.cloud.secretmanager.v1.IAddSecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IAddSecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    getSecret(request: protos.google.cloud.secretmanager.v1.IGetSecretRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.IGetSecretRequest | undefined, {} | undefined]>;
    getSecret(request: protos.google.cloud.secretmanager.v1.IGetSecretRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.IGetSecretRequest | null | undefined, {} | null | undefined>): void;
    ...
    updateSecret(request: protos.google.cloud.secretmanager.v1.IUpdateSecretRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.IUpdateSecretRequest | undefined, {} | undefined]>;
    updateSecret(request: protos.google.cloud.secretmanager.v1.IUpdateSecretRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecret, protos.google.cloud.secretmanager.v1.IUpdateSecretRequest | null | undefined, {} | null | undefined>): void;
    ...
    deleteSecret(request: protos.google.cloud.secretmanager.v1.IDeleteSecretRequest, options?: gax.CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.secretmanager.v1.IDeleteSecretRequest | undefined, {} | undefined]>;
    deleteSecret(request: protos.google.cloud.secretmanager.v1.IDeleteSecretRequest, options: gax.CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.secretmanager.v1.IDeleteSecretRequest | null | undefined, {} | null | undefined>): void;
    ...
    getSecretVersion(request: protos.google.cloud.secretmanager.v1.IGetSecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IGetSecretVersionRequest | undefined, {} | undefined]>;
    getSecretVersion(request: protos.google.cloud.secretmanager.v1.IGetSecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IGetSecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    accessSecretVersion(request: protos.google.cloud.secretmanager.v1.IAccessSecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.IAccessSecretVersionResponse, (protos.google.cloud.secretmanager.v1.IAccessSecretVersionRequest | undefined), {} | undefined]>;
    accessSecretVersion(request: protos.google.cloud.secretmanager.v1.IAccessSecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.IAccessSecretVersionResponse, protos.google.cloud.secretmanager.v1.IAccessSecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    disableSecretVersion(request: protos.google.cloud.secretmanager.v1.IDisableSecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion, (protos.google.cloud.secretmanager.v1.IDisableSecretVersionRequest | undefined), {} | undefined]>;
    disableSecretVersion(request: protos.google.cloud.secretmanager.v1.IDisableSecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IDisableSecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    enableSecretVersion(request: protos.google.cloud.secretmanager.v1.IEnableSecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion, (protos.google.cloud.secretmanager.v1.IEnableSecretVersionRequest | undefined), {} | undefined]>;
    enableSecretVersion(request: protos.google.cloud.secretmanager.v1.IEnableSecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IEnableSecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    destroySecretVersion(request: protos.google.cloud.secretmanager.v1.IDestroySecretVersionRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion, (protos.google.cloud.secretmanager.v1.IDestroySecretVersionRequest | undefined), {} | undefined]>;
    destroySecretVersion(request: protos.google.cloud.secretmanager.v1.IDestroySecretVersionRequest, options: gax.CallOptions, callback: Callback<protos.google.cloud.secretmanager.v1.ISecretVersion, protos.google.cloud.secretmanager.v1.IDestroySecretVersionRequest | null | undefined, {} | null | undefined>): void;
    ...
    listSecrets(request: protos.google.cloud.secretmanager.v1.IListSecretsRequest, options: gax.CallOptions, callback: PaginationCallback<protos.google.cloud.secretmanager.v1.IListSecretsRequest, protos.google.cloud.secretmanager.v1.IListSecretsResponse | null | undefined, protos.google.cloud.secretmanager.v1.ISecret>): void;
     ...
     */
    listSecretsStream(request?: protos.google.cloud.secretmanager.v1.IListSecretsRequest, options?: gax.CallOptions): Transform;
    /**
     ...
     */
    listSecretsAsync(request?: protos.google.cloud.secretmanager.v1.IListSecretsRequest, options?: gax.CallOptions): AsyncIterable<protos.google.cloud.secretmanager.v1.ISecret>;
    listSecretVersions(request: protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.secretmanager.v1.ISecretVersion[], protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest | null, protos.google.cloud.secretmanager.v1.IListSecretVersionsResponse]>;
    listSecretVersions(request: protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest, options: gax.CallOptions, callback: PaginationCallback<protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest, protos.google.cloud.secretmanager.v1.IListSecretVersionsResponse | null | undefined, protos.google.cloud.secretmanager.v1.ISecretVersion>): void;
     ...
     */
    listSecretVersionsStream(request?: protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest, options?: gax.CallOptions): Transform;
    /**
     ...
     *   An iterable Object that conforms to @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols.
     */
    listSecretVersionsAsync(request?: protos.google.cloud.secretmanager.v1.IListSecretVersionsRequest, options?: gax.CallOptions): AsyncIterable<protos.google.cloud.secretmanager.v1.ISecretVersion>;
    /**
